...
function createWhatsAppBot({clientId,messageHandler,state,logger,reconnectDelayMs,calculateAdminGroupId,calculationRepository,isAdmin}){
 ...
 client.on('message',createCalculationHandler({logger,client,adminGroupId:calculateAdminGroupId,calculationRepository,isAdmin}));
