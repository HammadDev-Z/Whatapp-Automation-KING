...
function createWhatsAppBot({clientId,messageHandler,state,logger,reconnectDelayMs,calculateAdminGroupId}){
 ...
 client.on('message',createCalculationHandler({logger,client,adminGroupId:calculateAdminGroupId}));
